...
public class Company {
    ...
    private List<Staff> staff; //list of staff with staff class creation
    ...
    public Company(Integer id, String companyName, Set<String> typeOfCars, List<Staff> staff, List<Car> allCars) {
        this.id = id;
        this.companyName = companyName;
        this.typeOfCars = typeOfCars;
        this.staff = staff;
